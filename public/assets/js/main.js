  ...
  $(document).ready(function () {
    ...
    $(window).on("scroll", function () {
      ...
      if (yOffset >= triggerPoint) {
        $(".header").addClass("sticky-header sticky-fixed-top");
      } else {
        $(".header").removeClass("sticky-header sticky-fixed-top");
      }
    });
    ...
    $("#main-slider").slick({
      ...
      fade: true,
      prevArrow:
        '<div class="slick-prev"><i class="las la-long-arrow-alt-left"></i></div>',
      nextArrow:
        '<div class="slick-next"><i class="las la-long-arrow-alt-right"></i></div>',
    });
